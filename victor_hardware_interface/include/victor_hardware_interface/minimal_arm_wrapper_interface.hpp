...
namespace victor_hardware_interface {
    ...
    protected:
        ...
        validateJointPathExecutionParams(const JointPathExecutionParameters &params);

        static std::pair<bool, std::string>
        validateCartesianPathExecutionParams(const CartesianPathExecutionParameters &params);

        static std::pair<bool, std::string> validateJointImpedanceParams(const JointImpedanceParameters &params);

        static std::pair<bool, std::string>
        validateCartesianImpedanceParams(const CartesianImpedanceParameters &params);

        static std::pair<bool, std::string>
        validateCartesianControlModeLimits(const CartesianControlModeLimits &params);
        ...
        validateCartesianPose(const geometry_msgs::Pose &pose, const std::string &frame) const;
