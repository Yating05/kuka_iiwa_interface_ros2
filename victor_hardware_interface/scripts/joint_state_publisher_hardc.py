...
class VictorJointStatePublisher:
    ...
    def set_arm_position_values(self, motion_status, offset):
        with self.joint_state_lock:
            self.joint_state_msg.position[offset + 0] = 0.36
            self.joint_state_msg.position[offset + 1] = 1.96
            self.joint_state_msg.position[offset + 2] = 1.09
            self.joint_state_msg.position[offset + 3] = 1.48
            self.joint_state_msg.position[offset + 4] = -2.19
            self.joint_state_msg.position[offset + 5] = 0.74
            self.joint_state_msg.position[offset + 6] = 0.96
